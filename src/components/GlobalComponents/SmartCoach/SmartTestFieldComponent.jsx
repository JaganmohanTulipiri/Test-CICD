import { CardBody, Icon, Input, InputGroup, Stack } from "@chakra-ui/react";
...
const SmartTestFieldComponent = (props) => {
  const {
  ...
  const filteredOptions =
    testSelectionResponseList?.length > 0 &&
...
export default SmartTestFieldComponent;
