...
import { getActivityGramEventsList } from '../../../features/teacher/teacherSlice';
...
const ActivitySkeleton = (props) => {
  ...
  useEffect(() => {
    dispatch(getActivityGramEventsList({ token, userId, role }));
  }, []);
  return (
    <>
      <Box
      ...
      >
        ...
        >
          <Flex>
            <Box px='4' mt={10} mx={{ lg: '28', xl: '3' }}>
              <Text textStyle={'text'}>ACTIVITYGRAM TEST EVENTS</Text>
            </Box>
          </Flex>
          ...
          >
            <Box
              ...
              flexBasis='auto'
            >
              <SimpleGrid columns={{ md: 2, lg: 3 }} rowGap={5} columnGap={2}>
                {testEventsList?.length &&
                  testEventsList?.map((item) => (
                    <Card
                      w={{ md: 300, lg: 250, xl: 320 }}
                      boxShadow='lg'
                      border='1px'
                      borderColor='white'
                      borderRadius='15'
                ...
                <Card>
                  <CardBody>
                    ...
                    <Text textStyle='textHead'>
                      For best results, be as accurate as you can!
                    </Text>
                  </CardBody>
                </Card>
              </Box>
