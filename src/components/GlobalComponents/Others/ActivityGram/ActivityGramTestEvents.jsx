...
import ActivityModalSkeleton from "../../Others/ActivityModalSkeleton";
...
import ActivityGramEventModal from "./ActivityGramEventModal";

const ActivityGramTestEvents = () => {
	...
	const [testEventsList, setEestEventsList] = useState(
		activityGramEventsList?.slice(0, 6),
	);
...
export default ActivityGramTestEvents;
