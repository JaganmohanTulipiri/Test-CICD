...
const ActivityGramEventModal = (props) => {
	console.log(props, "iam propd");
	...
	return (
		<>
			<Modal isOpen={isViewDataClicked} onClose={onClose} size="sm" isCentered>
				<ModalOverlay />
				<ModalContent>
...
export default ActivityGramEventModal;
