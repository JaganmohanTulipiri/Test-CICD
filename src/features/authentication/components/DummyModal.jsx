...
function DummyModal(props) {
  ...
  return (
    <>
      ...
      <Modal onClose={onClose} isOpen={checboxChecked} isCentered>
        <ModalOverlay />
        <ModalContent>
          <ModalBody>
            <>
            ...
            <h1 className='text-[#0081C8] mt-6 mb-4 md:text-xl lg:text-2xl font-bold xl:text-2xl xl:mb-3'>Disclaimer</h1>
        ...
        <button className='border-1 rounded-md text-[#F5F5F5] px-12 py-2 bg-[#0081C8]' onClick = {() => {
          disclaimerFunction(true)
          onClose
        }}>Accept</button>
        <button className='border-1 rounded-md text-[#282828] px-12 py-2 bg-[#F5F5F5]' onClick = {() => {
