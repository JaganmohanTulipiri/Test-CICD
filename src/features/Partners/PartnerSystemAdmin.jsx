...
import DistrictsSchools from "../Partners/customIcons/DistrictsSchoolsIcon.svg";
import Notifications from "../Partners/customIcons/notificationsIcon.svg";
...
const PartnerSystemAdmin = () => {
  ...
  return (
    <>
      ...
      <Flex marginTop="4">
        <Box backgroundColor="#0081C8" borderRadius="3xl">
          <Flex p="2">
        ...
        <Box backgroundColor="#0081C8" borderRadius="3xl" marginLeft="5">
          <Flex p="2">
