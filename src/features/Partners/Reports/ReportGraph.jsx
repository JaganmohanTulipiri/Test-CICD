    ...
    datasets: [
      {
        ...
        backgroundColor: ["#1DA2D5", "#80BDAD", "#4FA446"],
        barThickness: 40,
      },
    ],
  };
  ...
  return (
    <>
      <>
        ...
        <Box backgroundColor="#E8EAE9" w="14rem" h="3rem" p="3" fontSize="1rem">
          <Center>
      ...
      <Flex>
        ...
        <Flex marginLeft="15rem">
          <Box p="2">
            <Text textStyle="h4" marginLeft="10">Upper Body</Text>
            <Text>Strength/Endurance</Text>
          </Box>
          <Box p="2" marginLeft="10">
            <Text textStyle="h4" marginLeft="10">Abdominal</Text>
            <Text>Strength/Endurance</Text>
          </Box>
