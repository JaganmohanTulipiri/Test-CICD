...
const ActivityGramTestRegularPage = () => {
  ...
  console.log(tableBody, 'skhfh');
  return (
    <>
      <div className='m-5'>
        <div className='mt-6 pl-3 pr-3'>
          <Stack spacing='4'>
            <Text textStyle='h1'>{tableBody.first_name}</Text>
            <Flex>
              <Button
            ...
            <Table colorScheme='bg'>
              ...
              <Tbody>
                {tableBody?.map((each) => (
                  <Tr>
                    <Td
                      onClick={() => editButtonClicked(each)}
                      cursor='pointer'
                    >
                      {each.icon}
                    </Td>
        ...
        {/* <>
            {isRowItemClicked && isRowItemClicked ? (
              <>
                <ActivityGramTestRegularModalPage isRowItemClicked = {isRowItemClicked} changingBooleanRowItemFunction = {changingBooleanRowItemFunction}/>
              </>
            ) : null}
          </> */}
        <ActivityGramTestRegularModalPage
...
export default ActivityGramTestRegularPage;
