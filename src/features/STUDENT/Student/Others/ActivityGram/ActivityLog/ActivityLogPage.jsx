...
import { getActivityLogEvents } from "../../../../../../store/slices/profileSlice";
import ActivityLogModalPage from "./ActivityLogModalPage";
...
const ActivityLogPage = (props) => {
	...
	console.log("In ActivityLogPage", listItems);
    ...
    useEffect(() => {
        ...
        const userId = loginResponse?.response?.uuid;

			dispatch(getActivityLogEvents({ userId, token }));
		...
		<>
			<Box display="flex" justifyContent="center" h="full" w="full">
				...
				>
					<Flex>
						<Box px="4" mt={50} mx="3">
							<Text>ACTIVITYLOG CHALLENGES</Text>
						</Box>
					</Flex>
										...
										>
											<CardBody p="0">
												...
												<Box textAlign={"center"}>
													...
													<ActivityLogModalPage  selectedCardData={item}  />
