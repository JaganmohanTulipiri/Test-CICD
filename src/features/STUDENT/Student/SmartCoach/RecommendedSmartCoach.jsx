...
import TestSelectionSmartCoach from "./TestSelectionSmartCoach";
import { Rings } from "react-loader-spinner";

const RecommendedSmartCoach = () => {
  ...
  const smartCoachRecommendedList = useSelector(
  ...
  console.log(smartCoachRecommendedList, "smartCoachRecommendedList");
  ...
  const filteredOptions =
    smartCoachRecommendedList &&
    smartCoachRecommendedList?.filter((option) =>
  ...
  useEffect(() => {
    ...
    dispatch(getSmartCoach({ userDetails, token }));
...
export default RecommendedSmartCoach;
