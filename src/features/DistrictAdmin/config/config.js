import importIcon from "../../../assets/customIcons/Import (1).svg";
import manageUsersIcon from "../../../assets/customIcons/manageUsers.svg";
import manageClassesIcon from "../../../assets/customIcons/manageClassesIcon.svg";
import manageClasses from "../../../assets/customIcons/Manage Classes (1).svg";
import manageusers from "../../../assets/customIcons/Manage Users1.svg";
...
export const settingsData = {
  ...
  typeOfImport: {
    ...
    type2: {
      boolean: "Add, Update, and Remove",
      text: "Users, classes, and assignments will be created] updated, and existing records excluded from the file wil be inactivated ('Full' import) (*If selected, all classes for the school year should be imported) ",
    },
  },
};
...
export const CreateNewMappingData = {
  text: "Set up an import based on the file created by your district's Student Information System.	Map the data fields and save them to be used whenever data needs to be updated.",
