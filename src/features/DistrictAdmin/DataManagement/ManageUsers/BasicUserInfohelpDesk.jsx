...
const BasicUserInfohelpDesk = (props) => {
  console.log("props in BasicUserInfohelpDesk", props);
  ...
  const handleAdminData = () => {
    console.log("userType superAdmin for helpDesk", inputDetailsObj);
    const {
      re_enter_password,
      teacher_role,
    ...
    console.log(errorObj, "errorObj for help desk");

    setErrors({ ...errorObj });

    const userUUID = params.id;

    console.log("params in helpdesk", params.id);
