...
export const schoolAdminEndPoint = {
  ...
  //nithish
  getSchools: (skip) =>
    `${BASE_URL}/schools/getSchoolsForAdmin?size=${20}&skip=${skip}`,
  ...
  getClassbasedonSchool: () => `${BASE_URL}/userClass/getClassOfUsers`,
  ...
  getImportHistory: () => `${BASE_URL}/mappings/get-import-history`,
